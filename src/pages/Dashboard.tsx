      ...
      <section className="relative mx-auto max-w-6xl px-4 py-10 md:px-6">
        <div className="mb-8 flex items-end justify-between">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="mt-1 font-display text-4xl font-black text-foreground md:text-5xl">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {[
            { label: "Total analyses", value: stats.total, accent: "text-foreground", glow: "from-ink/20" },
        ...
        {history.length === 0 ? (
          <div className="mt-10 rounded-md border border-dashed border-border bg-card/40 p-12 text-center">
            ...
            <h3 className="mt-4 font-display text-2xl font-bold text-foreground">No analyses yet</h3>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-md border border-border bg-card p-6 shadow-paper">
                ...
                <div className="mt-2 text-center font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
                  Average score · <span className="text-foreground">{stats.avg} / 100</span>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 truncate font-display text-base text-foreground">{h.input_preview}</p>
                      </div>
